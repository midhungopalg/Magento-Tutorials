 ...
 */
class GroupAssignCustomTextAreaAttribute implements DataPatchInterface
{
    /**
    ...
    public function apply()
    {
        ...
        $eavSetup->addAttribute('catalog_product', 'custom_textarea_attribute', [
            'type' => 'text',
            'backend' => '',
            'frontend' => '',
            'label' => 'Custom TextArea Atrribute',
            'input' => 'textarea',
            'class' => '',
            'source' => '',

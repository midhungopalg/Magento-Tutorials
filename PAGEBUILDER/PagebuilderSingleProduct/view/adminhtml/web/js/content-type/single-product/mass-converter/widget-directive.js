...
define(["Magento_PageBuilder/js/mass-converter/widget-directive-abstract", "Magento_PageBuilder/js/utils/object"], function (_widgetDirectiveAbstract, _object) {
  ...
  var WidgetDirective = /*#__PURE__*/function (_widgetDirectiveAbstr) {
    ...
    _proto.toDom = function toDom(data, config) {
      var attributes = {
        type: "Midhun\\PagebuilderSingleProduct\\Block\\Widget\\SingleProductWidget",
        template: "Midhun_PagebuilderSingleProduct::widget/singleproduct.phtml",
        sku:"",
        type_name: "Single Product",
        anchor_text: "",
        id_path: "",
        show_pager: 0,
      ...
      if (data.productSku) {
        attributes.sku = data.productSku;
      }
